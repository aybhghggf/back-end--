  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <ul class="nav col-12 col-md-6 mb-2 justify-content-center mb-md-0">
        ...
        <li><a href="#" class="nav-link px-3">Smartphones</a></li>
        <li><a href="#" class="nav-link px-3">Deals</a></li>
        <li><a href="#" class="nav-link px-3">Support</a></li>
        <li><a href="#" class="nav-link px-3">About</a></li>
      </ul>

      <div class="col-md-3 text-end">
        <a href="login.php" class="btn btn-outline-primary me-2"><i class="bi bi-person"></i> Login</a>
        <a href="sign.php" class="btn btn-primary"><i class="bi bi-person-plus"></i> Sign up</a>
      </div>
    </div>
  </div>
</header>
